...
> Not Photoshop, it's PhotoSelect! A tiny tool to help you "declutter" your photo collection.
...
- **Large-photo review**: dark interface, photos maximized to fill the screen. Picking photos is all you see, no fancy buttons
...
- **Portrait picker (Same-Subject Mode)**: offline face recognition groups photos of the **same person in the same scene** together (matches both face and background), and correctly splits different people
...
4. Click "Start Analysis", then review the groups in the Group Overview, drag photos between groups if needed
...
- **Blur detection has limits**: very mild softness and true focus misses cannot always be told apart. If you actually want that dreamy soft look, just click Keep, it's your call
- **Extreme compositions may not auto-group**: a close-up big face and a distant tiny person may not be grouped together. Drag them together manually in the Group Overview, takes seconds
...
- **Are my photos uploaded anywhere?** No. The app runs fully offline, face recognition is processed on your own machine, your photos never leave your computer.
...
Found a bug or have a question? Your feedback is very welcome, every report makes it better. Contact info in the "Found a bug?" section above.
